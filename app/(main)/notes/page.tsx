        ...
        <div className="w-full mx-auto">
          ...
          {isLoading ? (
            ...
            <div className="h-[60vh] flex flex-col items-center justify-center text-center">
              <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center text-purple-500 dark:text-purple-400 mb-6 shadow-sm border border-purple-200 dark:border-purple-900/50">
                <FileText size={32} />
              </div>
              ...
              <Link
                href="/notes/new"
                className="flex items-center gap-2 bg-gradient-to-r from-[#7C3AED] to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white px-6 py-3 rounded-xl transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5 font-medium"
              >
                <Plus size={20} />
