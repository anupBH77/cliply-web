...
export default function Home() {
  return (
    <GuestRoute>
      <div className="min-h-screen bg-[#09090b] text-white selection:bg-zinc-500/30 overflow-x-hidden">
        {/* Header */}
        <header className="fixed top-0 w-full z-50 bg-[#09090b]/80 backdrop-blur-md border-b border-white/10">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <div className="flex items-center gap-8">
              <Link href="/" className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-400 to-zinc-500">
                Cliply
              </Link>
        ...
        <main>
          ...
          <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden flex flex-col items-center justify-center text-center px-4">
            <div className="absolute top-[20%] left-[50%] translate-x-[-50%] w-[800px] h-[400px] bg-zinc-600/20 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              <h1 className="text-6xl md:text-8xl font-extrabold tracking-tight mb-8">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-400 via-zinc-500 to-zinc-500">
                  Second Brain
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/signup" className="px-8 py-4 rounded-full bg-gradient-to-r from-zinc-500 to-zinc-600 hover:from-zinc-400 hover:to-zinc-500 text-white font-bold text-lg shadow-[0_0_30px_rgba(168,85,247,0.4)] transition-all duration-300 transform hover:scale-105 active:scale-95">
                  Start for Free
                </Link>
          ...
          <section id="features" className="py-24 bg-black/50 border-y border-white/5 relative scroll-mt-20">
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Feature 1 */}
                <div className="p-8 rounded-3xl bg-gradient-to-b from-white/5 to-transparent border border-white/10 hover:border-zinc-500/30 transition-colors group">
                  <div className="w-14 h-14 bg-zinc-500/20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <section id="how-it-works" className="py-24 relative overflow-hidden scroll-mt-20">
            <div className="absolute top-[30%] right-[-10%] w-[600px] h-[600px] bg-zinc-600/10 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center p-6">
                  <div className="w-16 h-16 rounded-full bg-zinc-500/20 border border-zinc-500/30 text-zinc-400 font-bold text-2xl flex items-center justify-center mx-auto mb-6">1</div>
                ...
                <div className="text-center p-6">
                  <div className="w-16 h-16 rounded-full bg-zinc-500/20 border border-zinc-500/30 text-zinc-400 font-bold text-2xl flex items-center justify-center mx-auto mb-6">2</div>
                ...
                <div className="text-center p-6">
                  <div className="w-16 h-16 rounded-full bg-zinc-500/20 border border-zinc-500/30 text-zinc-400 font-bold text-2xl flex items-center justify-center mx-auto mb-6">3</div>
